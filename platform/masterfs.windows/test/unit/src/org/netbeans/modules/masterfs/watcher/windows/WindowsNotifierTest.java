 ...
 */
public class WindowsNotifierTest extends NbTestCase {
    ...
    public WindowsNotifierTest(String name) {
        super(name);
    }
    
    @Override
    public boolean canRun() {
        return super.canRun() && Utilities.getOperatingSystem() == Utilities.OS_WIN_OTHER;
    }
